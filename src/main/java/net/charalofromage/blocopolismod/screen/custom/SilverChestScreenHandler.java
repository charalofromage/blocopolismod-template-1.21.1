...
public class SilverChestScreenHandler extends ScreenHandler {
    private final Inventory inventory;

    public SilverChestScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        this(syncId, playerInventory, playerInventory.player.getWorld().getBlockEntity(buf.readBlockPos()));
    }

    public SilverChestScreenHandler(int syncId, PlayerInventory playerInventory, BlockPos pos) {
    ...
    private static final int BG_WIDTH = 338;   // <-- remplace par la largeur de ton image
    ...
    public SilverChestScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity) {
        super(ModScreenHandlers.SILVER_CHEST_SCREEN_HANDLER, syncId);
