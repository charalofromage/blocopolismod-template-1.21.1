...
public static final ScreenHandlerType<MoneyGeneratorScreenHandler> MONEY_GENERATOR_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(BlocopolisMod.MOD_ID, "money_generator_screen_handler"),
                    new ExtendedScreenHandlerType<>(MoneyGeneratorScreenHandler::new, BlockPos.PACKET_CODEC));
